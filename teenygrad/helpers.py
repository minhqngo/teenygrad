...
OSX = platform.system() == "darwin"  # https://en.wikipedia.org/wiki/Darwin_(operating_system)
...
def argsort(x):  # https://stackoverflow.com/questions/3382352/equivalent-of-numpy-argsort-in-basic-python
...
class dtypes:
    ...
    def is_int(x: DType) -> bool:
        return x in (dtypes.int8, dtypes.int16, dtypes.int32, dtypes.int64, dtypes.uint8, dtypes.uint16, dtypes.uint32, dtypes.uint64)
